// Smooth gradient that dissolves the hero into the next (solid black)
// section — replaces the earlier wave shape, which read as a flat, lifeless
// line rather than an actual curve.
